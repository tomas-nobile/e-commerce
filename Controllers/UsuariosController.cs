...
namespace EcommerceWeb.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DNI,nombre,Apellido,Email")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DNI,nombre,Apellido,Email")] Usuario usuario)
        {
            if (id != usuario.DNI)
            {
                return NotFound();
